...
/**
 * Minimal, production-ready ConsultantBio component (editorial style).
 * - Two-column grid on desktop (md:grid-cols-12), image span 5, text span 7.
 * - Colors: forest #1a3c28, gold #f4d068, cream #faf8f5.
 * - Headings expect Playfair Display to be loaded at app level.
 * - This file alone is safe to add; it will not change live site behavior until imported.
 */
const ConsultantBio: React.FC<ConsultantBioProps> = ({
  ...
  return (
    <section
      ...
      aria-label="About Oluwo Dr. Faniyi Adebanjo Adifagbola"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 items-start">
        ...
        <figure className="md:col-span-5 flex justify-center md:justify-start">
          <div className="w-full max-w-md md:max-w-none">
            <div className="relative overflow-hidden rounded-2xl border-2 border-[#f4d068] shadow-lg">
              <Image
                src={portraitSrc}
                alt={portraitAlt}
                width={900}
        ...
        <div className="md:col-span-7">
          <header className="mb-6">
            <h1
              className="text-[#1a3c28] text-3xl md:text-4xl leading-tight"
            ...
            <p
              className="mt-3 text-[#f4d068] text-sm md:text-base font-semibold"
              style={{
                fontFamily:
          ...
          <div className="text-[#1a3c28] font-sans leading-relaxed">
