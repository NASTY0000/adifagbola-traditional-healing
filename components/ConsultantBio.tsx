...
/**
 * ConsultantBio
 * Editorial, magazine-style biography for the About page.
 *
 * Notes:
...
const ConsultantBio: React.FC<ConsultantBioProps> = ({
  // Default points to the public images location for a clean Next.js setup.
  // If the file has not yet been moved, pass the existing root path explicitly.
